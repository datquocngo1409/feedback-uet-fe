...
@Component({
  selector: 'gts-fe-not-rated-subject',
  templateUrl: './not-rated-subject.component.html',
  styleUrls: ['./not-rated-subject.component.scss']
})
export class NotRatedSubjectComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.subjectService.getList().subscribe(data => {
      ...
      if (localStorage.getItem('role') === 'STUDENT') {
        ...
        this.ratedSubjects = this.subjects;
      }
    });
  }
