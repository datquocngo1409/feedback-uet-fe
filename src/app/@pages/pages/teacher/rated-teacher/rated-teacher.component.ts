...
@Component({
  selector: 'gts-fe-rated-teacher',
  templateUrl: './rated-teacher.component.html',
  styleUrls: ['./rated-teacher.component.scss']
})
export class RatedTeacherComponent implements OnInit {
  teachers;
  student;
  selectedDate: Moment;
